...
"[project]/src/utils/db.ts [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[externals]/request-ip [external] (request-ip, cjs)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const mod = __turbopack_context__.x("request-ip", () => require("request-ip"));
...
"[project]/src/pages/api/guest.js [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/db.ts [api] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$request$2d$ip__$5b$external$5d$__$28$request$2d$ip$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/request-ip [external] (request-ip, cjs)");
...
async function handler(req, res) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"])();
    if (req.method === "POST") {
        try {
            ...
            if (!guest.hasCopiedProduct) {
                const publicProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$ProductRequest$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].find({
                    isPublic: true,
                    isSeed: true
                });
                const userProduct = publicProduct.map((i)=>({
                        ...i.toObject(),
                        _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Types.ObjectId(),
                        user: guest._id,
                        isPublic: true,
                        isSeed: false,
                        publicId: `${i.id}-${uuidv4()}`
                    }));
                await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$ProductRequest$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].insertMany(userProduct);
                await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$GuestUser$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(guest._id, {
                    $set: {
                        products: userProduct.map((inv)=>inv._id),
                        hasCopiedProduct: true
                    }
                });
            }
...
"[project]/node_modules/next/dist/esm/build/templates/pages-api.js { INNER_PAGE => \"[project]/src/pages/api/guest.js [api] (ecmascript)\" } [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$guest$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/pages/api/guest.js [api] (ecmascript)");
;
;
;
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$helpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["hoist"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$guest$2e$js__$5b$api$5d$__$28$ecmascript$29$__, 'default');
const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$helpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["hoist"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$guest$2e$js__$5b$api$5d$__$28$ecmascript$29$__, 'config');
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$pages$2d$api$2f$module$2e$compiled$2e$js__$5b$api$5d$__$28$ecmascript$29$__["PagesAPIRouteModule"]({
    ...
    userland: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$guest$2e$js__$5b$api$5d$__$28$ecmascript$29$__
}); //# sourceMappingURL=pages-api.js.map
}}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__cc9fa20b._.js.map