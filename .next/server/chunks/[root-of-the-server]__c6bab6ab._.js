        ...
        if (!guest.hasCopiedProduct) {
            ...
            const duplicatedProducts = seedProducts.map((product)=>{
                return new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$ProductRequest$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"]({
                    ...
                    isSeed: false,
                    isPublic: true,
                    publicId: `${product._id}-${(0, __TURBOPACK__imported__module__$5b$externals$5d2f$uuid__$5b$external$5d$__$28$uuid$2c$__esm_import$29$__["v4"])()}`,
                    user: guest._id,
                    createdAt: new Date(),
                    updatedAt: new Date()
                });
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$guest$2e$js__$5b$api$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$guest$2e$js__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6bab6ab._.js.map